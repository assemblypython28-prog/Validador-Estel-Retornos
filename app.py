...
st.set_page_config(
    page_title="Retorno de Obra - Estel",
    page_icon=data_url,
    layout="centered"
)

# --- INJEÇÃO DE METADADOS PARA PWA E OCULTAR MENUS ---
st.markdown(f"""
    <head>
        <link rel="apple-touch-icon" href="{data_url}">
        <link rel="icon" sizes="192x192" href="{data_url}">
    ...
    <style>
    /* Remove botões do GitHub, Fork e barra de ferramentas */
    button[data-testid="stActionButtonIcon"] {{display: none !important;}}
